...
pub async fn emails_page(event_store: &AppEventStore, email: Option<Markup>) -> impl IntoResponse {
    ...
    match esr.get_email_by_message_id(id) {
        Some(em) => {
            ...
            match hx_request {
                ...
                false => emails_page(event_store, Some(email_content))
                    .await
                    .into_response(),
            }
        }
        None => {
            ...
            match hx_request {
                ...
                false => emails_page(event_store, Some(not_found))
                    .await
                    .into_response(),
            }
        }
