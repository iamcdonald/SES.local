...
pub fn build(events: &Vec<&Event>, event: Option<Markup>, uri: &str) -> Markup {
    page_template::build(
        html! {
            script {
            ...
            div class="flex flex-col min-h-full" {
                div class="flex flex-row flex-grow min-h-full" {
                    ...
                    div id=(static_content::EVENT_DETAIL_ID) class="p-3 border-l-1 border-stone-100 grow shrink overflow-auto" {
